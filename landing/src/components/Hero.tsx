...
export function Hero({ stars }: HeroProps) {
  return (
    <section className="relative flex-1 px-6 py-12 lg:py-16">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
          ...
          <div className="relative">
            <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-[#5B47ED]/20 to-purple-500/20 blur-2xl" />
            <MockSidebar />
          </div>
        </div>
      </div>
