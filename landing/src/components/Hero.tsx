    ...
    <section className="relative flex-1 px-6 py-16 lg:py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mx-auto mt-10 max-w-xl text-center">
          <p className="text-lg text-gray-500 line-through decoration-gray-600">
        ...
        <div className="mx-auto mt-16 max-w-md">
          <h2 className="mb-5 text-center text-sm font-medium uppercase tracking-wider text-gray-500">Como funciona</h2>
